        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaturityLevel = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationCode = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CodeGeneratedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CodeExpiresAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MyLists_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchedPercentage = table.Column<double>(type: "double", nullable: false),
                    WatchedDuration = table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    LastWatched = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyLists_ContentId",
                table: "MyLists",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_MyLists_ProfileId",
                table: "MyLists",
                column: "ProfileId");
